...
import { Search, Grid, Filter, X } from 'lucide-react';
...
const Categories = () => {
  ...
  }, [searchQuery, selectedTags, selectedCategories, minRating]);
  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2">AI工具分类</h1>
          <p className="text-muted-foreground">
            浏览我们全面的AI工具集合，涵盖各种类别。使用筛选器找到最适合您需求的工具。
          </p>
        </div>
